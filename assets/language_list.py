...
'''
Контактные данные:
🗨 telegram link, phone number, google forms, e-mail и т.д.
'''
]
...
post_confirmed_message = [
    ...
    '✅ Ваш пост успешно прошел модерацию, был одобрен и размещен'
]
...
share_chanel_lang = [
'''
✊ Команда HoReCa Job UA 🇺🇦
<a href='https://telegra.ph/file/0bf2f0f902ee3029b7ce7.jpg'> </a>не залишається байдужою, і 
...
домівки у такій складний для 
всієї України та світу час, 
безкоштовні Телеграм-канали (https://t.me/horecajobeu/3) 
з підтримкою чат-бота (http://t.me/horecajobeubot), який 
допомагає знайти роботу за 
фахом у сфері гостинності
в інших країнах за кордоном.
...
Посилання для сторіс –
🗨 https://t.me/horecajobeu 
Зображення для сторіс ⤵️
(https://telegra.ph/file/0bf2f0f902ee3029b7ce7.jpg)
''',
'''
✊ Команда HoReCa Job UA 🇺🇦
не залишається байдужою, і 
...
message_was_sended = [
    '✅ Повiдомленя було вiдправлено усiм користувачам',
    '✅ Message was sended to all users',
    '✅ Сообщение было отпралено всем пользователям'
]
